    ...
    <section>
        {purchases.length > 0 ? (
          <ul>
                ...
                <article className="flex flex-col gap-2 sm:flex-row justify-center items-center my-3"> 
                  <div className="w-full">
                    ...
                    <div>
                      ...
                      <span className="text-sm">{purchase.items.length}{purchase.items.length == 1 ? " Artículo" : " Artículo"}</span>
                    </div>
                  </div>
            ...
            <h2 className="text-center sm:text-2xl font-bold">¡Aún no has realizado ninguna compra! </h2>
            <a href="/" className="hover:underline my-2 text-primary font-bold">¡Explora nuestra tienda y encuentra tus productos favoritos!</a>
          </div>
        )
        }
    </section>
